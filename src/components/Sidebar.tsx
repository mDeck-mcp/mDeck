...
import mcpdeckLogo from "../assets/mcpdeck-logo.png";
  ...
  return (
    <aside className="flex h-full w-56 flex-col border-r border-border bg-surface">
      <div className="flex h-14 items-center gap-2.5 border-b border-border px-4">
        <img src={mcpdeckLogo} alt="MCPDeck" className="h-7 w-auto object-contain" />
        <div className="flex items-baseline">
          <span className="text-sm font-bold text-primary">m</span>
          <span className="text-sm font-bold text-text">Deck</span>
        </div>
      </div>
